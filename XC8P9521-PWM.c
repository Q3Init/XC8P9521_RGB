...
// 宏定义声明
#define PWRKY_PORT() PORT5_0    // 电源按键
...
// 全局变量声明
static unsigned char led_mode = RGB_COLOR_CIR;		// 单色灯选择
static unsigned char led_switch = RGB_COLOR_CIR;	// 彩灯模式
static unsigned char mode_switch = 0;	// 运行模式
static unsigned char color_pwm_duty = 0;		// 彩灯的占空比
static unsigned char once_pwm_duty = 0;		// 单色灯的占空比
static unsigned char cir_mode = 0;	// 渐亮灭标志 1：渐亮 0：渐灭
...
static unsigned int pwrkey_cnt = 0;
static unsigned int ledkey_cnt = 0;
// 按键任务
void key_process(void)
{
...
unsigned int fun_delay = 0;
unsigned int cold_delay = 0;
